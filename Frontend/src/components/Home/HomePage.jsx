...
function HomePage() {
  return (
    <>
      ...
      <section>
        <LeftSide
          logo={<i className="fa-solid fa-microchip" style={{ fontSize: "20rem" }}></i>}
          heading="Processors"
          view_button="View All Processors"
          button_data={[
      ...
      <section>
        <RightSide
          logo={<i className="fa-solid fa-computer" style={{ fontSize: "20rem" }}></i>}
      ...
      <section>
        <LeftSide
          logo={<i className="fa-solid fa-brain" style={{ fontSize: "20rem" }}></i>}
      ...
      <section>
        <RightSide
          logo={<i className="fa-solid fa-network-wired" style={{ fontSize: "20rem" }}></i>}
      ...
      <section>
        <LeftSide
          logo={<i className="fa-solid fa-boxes-stacked" style={{ fontSize: "20rem" }}></i>}
